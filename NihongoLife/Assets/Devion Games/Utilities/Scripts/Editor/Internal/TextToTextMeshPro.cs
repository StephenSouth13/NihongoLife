...
namespace DevionGames
{
	public class TextToTextMeshPro : EditorWindow
	{
        ...
        private void OnEnable()
        {
			...
			this.m_Texts = Object.FindObjectsByType<Text>(FindObjectsSortMode.None);
		...
		private void UpdateToTextMeshPro(Text component) {
			...
			textMeshPro.textWrappingMode = wrap ? TextWrappingModes.Normal : TextWrappingModes.NoWrap;
